...
function MonthGrid({
  ...
  anchor: Date;
  events: TaskEvent[];
  onDragStart: (ev: TaskEvent, e: React.DragEvent) => void;
        ...
        return (
          <div
            ...
            onDrop={(e) => {
              ...
              if (taskId && fromDate) {
                onDragStart({ id: taskId, due_date: fromDate } as any, e);
              }
            }}
            style={{
              minHeight: "100px",
...
export function CalendarView({
  ...
  const handleDragStart = useCallback((ev: TaskEvent, _e: React.DragEvent) => {
    setDragTarget(ev.id);
  }, []);
